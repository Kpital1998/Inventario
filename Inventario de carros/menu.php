        ...
        <div class="titulo-nota">
            ...
            <a href="session_destroy.php"><img src="img/off-button.png" alt="" width="50" height="50" ></a>
        </div>
        <div class="lista-opciones">
            ...
            <div class="lista">
                ...
                <a href="Vendedores.php"><button><img src="img/employer.png" alt="" width="30" height="30">&nbsp;&nbsp;&nbsp;Vendedores</button></a><br><br><br>
